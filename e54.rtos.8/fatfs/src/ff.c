...
/*-----------------------------------------------------------------------*/
#if !_FS_READONLY
static FRESULT sync_window(          /* FR_OK:succeeded, !=0:error */
...
#if !_FS_READONLY
static void fit_lfn(const WCHAR *lfnbuf, /* Pointer to the LFN working buffer */
...
static int pattern_matching(                   /* 0:mismatched, 1:matched */
